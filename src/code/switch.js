...
<i-cell-group>
    <i-cell title="基本用法">
        <i-switch value="{{switch1}}" onChange="onChange" slot="footer"></i-switch>
    </i-cell>
    <i-cell title="自定义内容">
        <i-switch value="{{switch1}}" size="large" onChange="onChange" slot="footer">
            <view slot="open">开启</view>
            <view slot="close">关闭</view>
        </i-switch>
    </i-cell>
    <i-cell title="图标">
        <i-switch value="{{switch1}}" onChange="onChange" slot="footer">
