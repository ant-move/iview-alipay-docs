...
<view style="margin-top: 100px">
    <i-button type="ghost" onClick="handleOpen1">一般用法</i-button>
    <i-button type="ghost" onClick="handleOpen2">带有提示、异步</i-button>
</view>
<i-action-sheet visible="{{ visible1 }}" actions="{{ actions1 }}" show-cancel onCancel="handleCancel1" onClick="handleClickItem1" />
